...
function App() {
  ...
  return (
    <div className="App">
      <div className="flex justify-center items-center h-screen bg-mobile-bg sm:bg-desktop-bg bg-cover bg-center">
        {/* Navbar */}
      ...
      <div className="p-6 mb-4 bg-slate-100">
        ...
        <p className="mt-4 text-lg sm:text-xl md:text-2xl">
          <ul>
            <li>
              <b>Snap a Selfie: </b>Grab your phone, find your best angle, and take a selfie at the wedding.
            </li>
            <li>
              <b>Upload & Share: </b>Use the camera icon to upload your photo and become part of our digital wedding album.
            </li>
            <li>
              <b>Spread the Love:</b> Feel free to add a fun message or tag your friends in the gallery.<br />
              Let&apos;s Create Memories Together!
            </li>
          </ul>
        </p>
        <p className="mt-4 text-lg sm:text-xl md:text-2xl">
          From the silly moments to the glamorous poses, every picture tells a story. So let’s fill this space with the best memories of our special day!
        </p>
      </div>
      ...
      <footer className="bg-black text-white text-center py-2 mt-6">
        <div className="container mx-auto">
          <p className="mb-2">
            ...
            <a href="https://www.instagram.com/adesanya_adeyemi_/" className="hover:text-pink-400 foot transition duration-300">
              {" "}
              Adesanya Adeyemi
            </a>
          </p>
